  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="mb-3">
          <label
            style={{ fontSize: 13, fontWeight: 600, color: "var(--text-secondary)", marginBottom: 6, display: "block" }}
          >
            Task Name
          </label>
          <TextField
      ...
      <div className="mb-4">
        ...
        {loadingTasks ? (
          ...
          <div
            ...
            style={{ backgroundColor: "var(--bg-card)", borderColor: "var(--border-light)", color: "var(--text-faint)", fontSize: 13 }}
          >

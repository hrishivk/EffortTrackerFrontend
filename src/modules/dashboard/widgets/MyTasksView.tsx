...
const selectSx = {
  ...
  "& .MuiInputBase-input": { padding: "8px 14px", fontSize: 13 },
};
...
export default function MyTasksView({ viewUserId, viewProject, viewTab }: MyTasksViewProps) {
  ...
  const taskColumns: Column<GroupedTask>[] = [
      ...
      ? [
          {
            ...
            render: (row: GroupedTask) => {
              ...
              if (total === 0) return <span style={{ fontSize: 12, color: "#9ca3af" }}>--</span>;
              if (total === 1) {
                const a = assignees[0];
                ...
                return (
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <span style={{ fontSize: 12, fontWeight: 500, color: "#374151" }}>{a.name}</span>
                  </div>
                );
              }
              ...
              return (
                <div className="d-flex align-items-center gap-2">
                  ...
                  <span style={{ fontSize: 11, color: "#6b7280", fontWeight: 600 }}>{total} assigned</span>
                </div>
              );
            },
      ...
      : []),
    {
      ...
      header: "Start Time",
      render: (row) => {
        if (!row.start_time) return <span style={{ fontSize: 12, color: "#d1d5db" }}>--</span>;
    ...
    },
    {
      ...
      header: "End Time",
      render: (row) => {
        if (!row.end_time) return <span style={{ fontSize: 12, color: "#d1d5db" }}>--</span>;
        ...
        return (
          <div>
            ...
            <div style={{ fontSize: 10, color: isCompleted ? "#16a34a" : "#9ca3af" }}>
              {d.toLocaleTimeString("en-US", { hour: "2-digit", minute: "2-digit" })}
            </div>
          </div>
        );
  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <FormControl size="small" sx={{
            ...
            "& .MuiInputBase-input": { padding: "8px 18px", fontSize: 13, fontWeight: 600 },
          }}>
            <Select
              value={projectFilter}
          ...
          {/* Create Task Button — hidden when form is open */}
          {!showCreateForm && (
            <button
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 px-5 py-3 mb-5 flex flex-wrap justify-between items-center gap-3">
        <div className="flex items-center gap-3">
          {/* View Mode Toggle */}
          <div
            style={{
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                color: viewMode === "gantt" ? "#fff" : "#6b7280",
                borderRadius: 0,
                fontSize: 13,
                fontWeight: 600,
                padding: "8px 18px",
          ...
          {viewMode !== "gantt" && (
            <div className="flex items-center gap-1.5">
              ...
              <div className="relative w-8 h-8 flex-shrink-0">
                ...
                />
                <div
                  className="absolute inset-0 flex items-center justify-center hover:bg-gray-100 transition"
                  style={{ border: "1px solid #e5e7eb", borderRadius: 10, zIndex: 1 }}
                >
        ...
        {activeProjects.length > 0 && (
          <div className="flex items-center gap-4 text-xs">
            <span className="text-gray-400 font-semibold uppercase tracking-wider">Projects:</span>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-5 h-full">
                ...
                <div className="mb-4">
                  <div className="d-flex align-items-center justify-content-between mb-2">
                    <span className="text-sm font-semibold text-gray-700" style={{ lineHeight: 1 }}>
                      Assignee
                    </span>
                    {role === "AM" && (
                      <div
                      ...
                      >
                        ...
                        />
                        <span style={{ fontSize: 12, fontWeight: 500, color: "#4b5563", cursor: "pointer" }}>
                          Assign to myself
                        </span>
                      </div>
                    )}
                  ...
                  {assignToSelf ? (
                    ...
                    >
                      ...
                      <div>
                        <p className="text-sm font-semibold text-gray-800" style={{ margin: 0 }}>
                          {user?.fullName || "Me"}
                        </p>
                  ...
                  <div className="flex gap-2">
                    {[
                      ...
                      <button
                        ...
                        style={{
                          borderRadius: 12,
                          borderColor: form.priority === p.key ? p.color : "#e5e7eb",
                          backgroundColor: form.priority === p.key ? p.bg : "#fff",
                        }}
                      >
                ...
                <div className="flex gap-3">
                  <button
                    className="flex-1 btn border border-gray-300 text-gray-700 font-semibold"
